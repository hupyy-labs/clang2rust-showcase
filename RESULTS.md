...
| 44 | [hydra](https://github.com/emad-elsaid/hydra) · [mirror](https://github.com/o2alexanderfedin/hydra-rust-mirror) | C++ ✅ · Rust ✅ | C++ 1/1 · Rust 1/1 | A/B C++ —·Rust — · pass@1 — | 436 | 418 | +4.1% |
...
**Aggregate over the 16 both-mode-measured project(s):** before 64,271 → after 63,577 unsafe expressions (Change +1.1%); 84 project(s) excluded (n/a (build)).
<!-- crust-table:end -->
